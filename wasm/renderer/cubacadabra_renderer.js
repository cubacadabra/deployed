 ...
 */
export class WasmServerAuthority {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmServerAuthorityFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmserverauthority_free(ptr, 0);
    }
    /**
     * @param {string} snapshot_json
     * @param {string} authenticated_actor_id
    ...
    execute_json(snapshot_json, authenticated_actor_id, command_json) {
        ...
        try {
            ...
            const ptr1 = passStringToWasm0(authenticated_actor_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(command_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.wasmserverauthority_execute_json(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
    ...
    /**
     * @param {string} initial_state_json
     * @returns {string}
     */
    initial_snapshot_json(initial_state_json) {
        ...
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(initial_state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmserverauthority_initial_snapshot_json(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    constructor(rules_source) {
        const ptr0 = passStringToWasm0(rules_source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmserverauthority_load(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        WasmServerAuthorityFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) WasmServerAuthority.prototype[Symbol.dispose] = WasmServerAuthority.prototype.free;
...
export class WebClient {
     ...
     */
    engine_handle() {
        const ret = wasm.webclient_engine_handle(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    constructor(manifest, script) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
    ...
    poll_actions_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webclient_poll_actions_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    receive_text(source) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_receive_text(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    request_transport() {
        wasm.webclient_request_transport(this.__wbg_ptr);
    }
    /**
     * @param {string} source
     * @returns {boolean}
     */
    set_ignored_player_ids_json(source) {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_set_ignored_player_ids_json(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    transport_connected() {
        wasm.webclient_transport_connected(this.__wbg_ptr);
    }
    transport_disconnected() {
        wasm.webclient_transport_disconnected(this.__wbg_ptr);
    }
}
...
export class WebRenderer {
    static __wrap(ptr) {
        const obj = Object.create(WebRenderer.prototype);
        obj.__wbg_ptr = ptr;
        WebRendererFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
     ...
     */
    appearance_mode() {
        const ret = wasm.webrenderer_appearance_mode(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @param {number} width
     * @param {number} height
     * @returns {Promise<WebRenderer>}
     */
    static create(canvas, width, height) {
        const ret = wasm.webrenderer_create(canvas, width, height);
        return ret;
    }
    draw() {
        wasm.webrenderer_draw(this.__wbg_ptr);
    }
    /**
    ...
    register_morph_pack(bytes) {
        const ret = wasm.webrenderer_register_morph_pack(this.__wbg_ptr, bytes);
        return ret !== 0;
    }
    /**
     * @param {string} id
     ...
     * @returns {boolean}
     */
    register_world_mesh(id, bytes) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webrenderer_register_world_mesh(this.__wbg_ptr, ptr0, len0, bytes);
        return ret !== 0;
    }
    /**
     * @param {number} width
     ...
     */
    resize(width, height) {
        wasm.webrenderer_resize(this.__wbg_ptr, width, height);
    }
    /**
    ...
    set_appearance_mode(mode) {
        const ret = wasm.webrenderer_set_appearance_mode(this.__wbg_ptr, mode);
        return ret !== 0;
    }
    /**
     * @param {boolean} enabled
     */
    set_avatar_preview_mode(enabled) {
        wasm.webrenderer_set_avatar_preview_mode(this.__wbg_ptr, enabled);
    }
    /**
     * @param {string} id
     * @param {number} width
     ...
     * @returns {boolean}
     */
    set_package_image(id, width, height, pixels) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webrenderer_set_package_image(this.__wbg_ptr, ptr0, len0, width, height, pixels);
        return ret !== 0;
    }
    /**
     * @param {number} width
    ...
    set_package_image_atlas(width, height, pixels, regions) {
        const ptr0 = passStringToWasm0(regions, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webrenderer_set_package_image_atlas(this.__wbg_ptr, width, height, pixels, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {number} engine
     */
    sync_engine(engine) {
        wasm.webrenderer_sync_engine(this.__wbg_ptr, engine);
    }
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_cceaf62d8d95e9f2: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___js_sys_4239be16af55d66___Function_fn_wasm_bindgen_7e5afd6afbe449db___JsValue_____wasm_bindgen_7e5afd6afbe449db___sys__Undefined___js_sys_4239be16af55d66___Function_fn_wasm_bindgen_7e5afd6afbe449db___JsValue_____wasm_bindgen_7e5afd6afbe449db___sys__Undefined_______true_(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbg_webrenderer_new: function(arg0) {
            const ret = WebRenderer.__wrap(arg0);
            return ret;
        },
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 2254, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___wasm_bindgen_7e5afd6afbe449db___JsValue__core_f0fd674eaa06beef___result__Result_____wasm_bindgen_7e5afd6afbe449db___JsError___true_);
            return ret;
        },
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___wasm_bindgen_7e5afd6afbe449db___JsValue______true_);
            return ret;
        },
    ...
    return {
        __proto__: null,
        "./cubacadabra_renderer_bg.js": import0,
    };
}

function wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___wasm_bindgen_7e5afd6afbe449db___JsValue______true_(arg0, arg1, arg2) {
    wasm.wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___wasm_bindgen_7e5afd6afbe449db___JsValue______true_(arg0, arg1, arg2);
}

function wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___wasm_bindgen_7e5afd6afbe449db___JsValue__core_f0fd674eaa06beef___result__Result_____wasm_bindgen_7e5afd6afbe449db___JsError___true_(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___wasm_bindgen_7e5afd6afbe449db___JsValue__core_f0fd674eaa06beef___result__Result_____wasm_bindgen_7e5afd6afbe449db___JsError___true_(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___js_sys_4239be16af55d66___Function_fn_wasm_bindgen_7e5afd6afbe449db___JsValue_____wasm_bindgen_7e5afd6afbe449db___sys__Undefined___js_sys_4239be16af55d66___Function_fn_wasm_bindgen_7e5afd6afbe449db___JsValue_____wasm_bindgen_7e5afd6afbe449db___sys__Undefined_______true_(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_7e5afd6afbe449db___convert__closures_____invoke___js_sys_4239be16af55d66___Function_fn_wasm_bindgen_7e5afd6afbe449db___JsValue_____wasm_bindgen_7e5afd6afbe449db___sys__Undefined___js_sys_4239be16af55d66___Function_fn_wasm_bindgen_7e5afd6afbe449db___JsValue_____wasm_bindgen_7e5afd6afbe449db___sys__Undefined_______true_(arg0, arg1, arg2, arg3);
}
...
const WasmServerAuthorityFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmserverauthority_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cubacadabra_renderer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
