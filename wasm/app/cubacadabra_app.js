export class WebApp {
    ...
    dispatch_json(source) {
        ...
        const ret = wasm.webapp_dispatch_json(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    constructor() {
        const ret = wasm.webapp_new();
        this.__wbg_ptr = ret;
     ...
     */
    poll_effect_json() {
        const ret = wasm.webapp_poll_effect_json(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    snapshot_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.webapp_snapshot_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cubacadabra_app_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
